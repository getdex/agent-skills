...
- Reuse the `email` returned by calendar reads as `account_email`; create/update/delete also accept `account_provider` for duplicate-address connections, while get-by-ID does not
